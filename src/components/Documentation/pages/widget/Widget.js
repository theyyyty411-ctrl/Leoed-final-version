...
const WidgetPage = () => {
  ...
  return (
    <Widget title={"Typography"} inheritHeight disableWidgetMenu>
      <Typography variant={"body2"}>Provide widget on your page.</Typography>
      ...
      <TabPanel index={0} value={value}>
        <Widget title={"Widget example"}>Widget with the title</Widget>
      </TabPanel>
    ...
    <Widget title={"Title"} subtitle={"subtitle"}>
      ...
      <TabPanel index={0} value={colorValue}>
        <Widget noBodyPadding>No body padding</Widget>
      </TabPanel>
    ...
    <Widget header={(
      ...
      <Box mt={1}>
        <Link
          href={"https://mui.com/material-ui/api/paper/"}
          color={"primary"}
