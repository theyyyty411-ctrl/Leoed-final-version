    ...
    <div className={classes.root}>
      <div className={classes.starterBlock}>
        ...
        <p>
          ...
          <a href="https://localhost/generator">Web App Generator</a>. For
          guides and documentation please check your local README.md and{" "}
          <a href="https://localhost/documentation">documentation</a>.
        </p>
