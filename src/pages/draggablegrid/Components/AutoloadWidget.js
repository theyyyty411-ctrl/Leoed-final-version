      ...
      <Grid container direction={"column"} size={12}>
        ...
        <Grid>
          <Typography className={classes.blocksMargin}>
            To make a widget automatically load it's content you just need to
            set <strong>autoload</strong> attribute and provide an api to update
            the widget content.
          </Typography>
          <TextField
          ...
          <Typography className={classes.blocksMargin}>
            <strong>autoload</strong> may be set to an integer value. If set,
            for example, to 2000 will refresh widget every 2 seconds.
          </Typography>
