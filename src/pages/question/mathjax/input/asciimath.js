(() => {
  var t = {
        ...
        ((e.E = u),
          ...
          (function (t) {
            ...
            var n = function (t) {
              ...
              a = function (t) {
                return eval.call(h, t);
              },
              s = function () {
                if ((a("var __TeSt_VaR__ = 1"), h.__TeSt_VaR__))
                  try {
                    delete h.__TeSt_VaR__;
                  } catch (t) {
                    h.__TeSt_VaR__ = null;
                  }
                else
                    ...
                    : function (i) {
                        ((e.__code = i),
                          (i =
                            ...
                            t +
                            ".__result = err}"));
                        var n = c.getElementsByTagName("head")[0];
                        n || (n = c.body);
                        var a = c.createElement("script");
                        (a.appendChild(c.createTextNode(i)),
                          n.appendChild(a),
                          n.removeChild(a));
                        var s = e.__result;
                        if (
              ...
              m = u.Object.Subclass({
                ...
                Execute: function () {
                  ...
                  for (var e = 0, i = this.hooks.length; e < i; e++) {
                    ...
                    var a = this.hooks[e].apply(h, arguments);
              ...
              g = f.Subclass(
                ...
                },
                {
                  ...
                  find: function (t) {
                    return (
                      g.signals[t] || (g.signals[t] = new g(t)),
                      g.signals[t]
                    );
                  },
                },
          ...
          (function (t) {
            ...
            e || (e = h[t] = {});
            var i =
                "Apple Computer, Inc." === p.vendor && void 0 === p.vendorSub,
              n = 0,
              a = [],
              s = function () {
              ...
              (e.Ajax = {
                ...
                fileName: function (e) {
                  ...
                  if (e.substr(0, i.length) === i)
                    e = "[" + t + "]" + e.substr(i.length);
                  else
                    for (var n in r)
                      if (
                        r.hasOwnProperty(n) &&
                        r[n] &&
                        e.substr(0, r[n].length) === r[n]
                      ) {
                        e = "[" + n + "]" + e.substr(r[n].length);
                        break;
                      }
                  return e;
                },
                ...
                Require: function (t, i) {
                  ...
                  if (((i = e.Callback(i)), t instanceof Object))
                    for (var a in t)
                      t.hasOwnProperty(a) &&
                        ((n = a.toUpperCase()), (t = t[a]));
                  else n = t.split(/\./).pop().toUpperCase();
                  if (((t = this.fileURL(t)), this.loaded[t]))
                    i(this.loaded[t]);
                  else {
                    var s = {};
                    ((s[n] = t), this.Load(s, i));
                ...
                Load: function (t, i) {
                  ...
                  if (((t = this.fileURL(t)), this.loading[t]))
                    this.addHook(t, i);
                  else {
                ...
                addHook: function (t, e, i) {
                  (this.loadHooks[t] ||
                    (this.loadHooks[t] = u.Callback.Hooks()),
                ...
                loader: {
                  JS: function (t, i) {
                    ...
                    ((this.loading[t] = {
                      ...
                      h.System ? h.System.import(t).catch(a) : a());
                  },
                  CSS: function (t, i) {
                    var n = this.fileName(t),
                ...
                timer: {
                  ...
                  checkSafari2: function (t, e, i) {
                    t.time(i) ||
                      (c.styleSheets.length > e &&
                      c.styleSheets[e].cssRules &&
                      c.styleSheets[e].cssRules.length
                        ? i(t.STATUS.OK)
                ...
                loadComplete: function (t) {
                  ...
                  return (
                    ...
                    this.loadHooks[t]
                      ? this.loadHooks[t].Execute(i.status)
                      : null
                  );
                },
                loadTimeout: function (t) {
                  (this.loading[t].timeout &&
                    clearTimeout(this.loading[t].timeout),
                  ...
                  if ("" === n) (i = e.Callback(i))();
                    ...
                    ((a.type = "text/css"),
                      ...
                      a.styleSheet && void 0 !== a.styleSheet.cssText
                        ...
                        : a.appendChild(c.createTextNode(n)),
          ...
          (u.Localization = {
            ...
            processMarkdown: function (t, e, i) {
              for (
                ...
                (s[o + 1]
                  ? ((n = this.processString(s[o + 2], e, i)) instanceof
                      Array || (n = [n]),
            ...
            loadFile: function (t, e, i) {
              ...
              t.match(/^([a-z]+:|\[MathJax\])/)) ||
                (t =
                  ...
                  "/" +
                  t);
              var n = u.Ajax.Require(t, function () {
            ...
            loadDomain: function (t, e) {
              ...
              if (n) {
                if (!n.isLoaded && (i = this.loadFile(this.locale, n)))
                  return u.Callback.Queue(i, ["loadDomain", this, t]).Push(
                    e || {},
                  );
                if (n.domains && t in n.domains) {
                  var a = n.domains[t];
                  if (!a.isLoaded && (i = this.loadFile(t, a)))
                    return u.Callback.Queue(i).Push(e);
                }
              }
              return u.Callback(e)();
            },
            Try: function (t) {
              (t = u.Callback(t)).autoReset = !0;
              try {
                t();
              } catch (e) {
                if (!e.restart) throw e;
                u.Callback.After(["Try", this, t], e.restart);
              }
            },
            ...
            setLocale: function (t) {
              (this.resetLocale(t), u.Menu && this.loadDomain("MathMenu"));
            },
            addTranslation: function (t, e, i) {
              ...
              (n || ((n = this.strings[t] = {}), (a = !0)),
                ...
                u.Hub.Insert(n, i),
                a && u.Menu.menu && u.Menu.CreateLocaleMenu());
            },
            setCSS: function (t) {
          ...
          (u.Message = {
            localize: function (t) {
              return u.Localization._(t, t);
            },
            filterText: function (t, e, i) {
              return (
                "simple" === u.Hub.config.messageStyle &&
                  ("LoadFile" === i
                    ? (this.loading ||
            ...
            Set: function (t, e, i) {
              u.debug &&
                (Array.isArray(t) &&
                  (t = u.Localization._.apply(u.Localization, t)),
          ...
          (u.Hub = {
            ...
            Register: {
              PreProcessor: function () {
                return u.Hub.preProcessors.Add.apply(
                  u.Hub.preProcessors,
                  arguments,
                );
              },
              MessageHook: function () {
                return u.Hub.signal.MessageHook.apply(u.Hub.signal, arguments);
              },
              StartupHook: function () {
                return u.Hub.Startup.signal.MessageHook.apply(
                  u.Hub.Startup.signal,
                  arguments,
                );
              },
              LoadHook: function () {
                return u.Ajax.LoadHook.apply(u.Ajax, arguments);
              },
            },
            UnRegister: {
              PreProcessor: function (t) {
                u.Hub.preProcessors.Remove(t);
              },
              MessageHook: function (t) {
                u.Hub.signal.RemoveHook(t);
              },
              StartupHook: function (t) {
                u.Hub.Startup.signal.RemoveHook(t);
              },
              LoadHook: function (t) {
                u.Ajax.removeHook(t);
              },
            ...
            RestartAfter: function (t) {
              throw this.Insert(Error("restart"), { restart: u.Callback(t) });
            },
            Insert: function (t, e) {
              for (var i in e)
                e.hasOwnProperty(i) &&
          ...
          (u.Extension = {}),
          (u.Hub.Startup = {
            queue: u.Callback.Queue(),
            signal: u.Callback.Signal("Startup"),
          }),
          (u.Ajax.config.root = u.Hub.config.root),
          (n = h[(i = "MathJax")]),
          (a = "[" + i + "]"),
          (s = n.Hub),
          (r = n.Ajax),
          ...
          (n.ElementJax = l.Subclass(
            {
              ...
              Reprocess: function (t) {
                ...
                return (
                  (e.MathJax.state = this.STATE.UPDATE),
                  s.Reprocess(e, t)
                );
              },
              Update: function (t) {
              ...
              Remove: function (t) {
                (this.hover && this.hover.clear(this),
                  ...
                  t ||
                    (s.signal.Post(["Remove Math", this.inputID]),
                    this.Detach()));
              },
              ...
              SourceElement: function () {
                return c.getElementById(this.inputID);
              },
              Attach: function (t, e) {
            ...
            ((t.mbase = MathJax.Object.Subclass(
              {
                ...
                SetData: function (e, i) {
                  (null != i &&
                    (i instanceof t.mbase ||
                      (i =
                        this.isToken || this.isChars ? t.chars(i) : t.mtext(i)),
                    (i.parent = this),
                ...
                texSpacing: function () {
                  var e =
                      null != this.prevClass ? this.prevClass : t.TEXCLASS.NONE,
              ...
              (t.mo = t.mbase.Subclass({
                ...
                CheckRange: function (e) {
                  ...
                  i >= 55296 &&
                    i < 56320 &&
                    (i =
                      ((i - 55296) << 10) + (e.charCodeAt(1) - 56320) + 65536);
                  for (
              ...
              (t.mrow = t.mbase.Subclass({
                ...
                setTeXclass: function (e) {
                  ...
                  if ((!this.open && !this.close) || (e && e.fnOP)) {
                    ...
                    return (
                      this.data[0] && this.updateTeXclass(this.data[0]),
                      e
                    );
                  }
            ...
            var e = t.TEXCLASS,
              i = {
                ...
                OP: [
                  ...
                  2,
                  e.OP,
                  { largeop: !0, movablelimits: !0, symmetric: !0 },
                ],
        ...
        (!(function (t) {
          ...
          var m = [
            ...
            T = [
              ...
              { input: "divide", tag: "mo", output: "-:", tex: null, ttype: E },
              {
                input: "@",
                tag: "mo",
                output: "\u2218",
          ...
          function A() {
            var t;
            for (T.sort(x), t = 0; t < T.length; t++) N[t] = T[t].input;
          }
          function R(t, e) {
            var i;
            i =
          ...
          function O(t) {
            ...
            if (((S = b), "" != s)) return ((b = T[e].ttype), T[e]);
            ((b = 0), (a = 1), (i = t.slice(0, 1)));
                ...
                : ((a = 2),
                  (n =
                    ...
                    ("a" > i || i > "z")
                      ...
                      : "mi")),
              "-" == i && " " !== t.charAt(1) && 3 == S
                ? ((b = 3), { input: i, tag: n, output: i, ttype: 1, func: !0 })
          ...
          function M(t) {
            ...
            if (null == (e = O((t = R(t, 0)))) || (5 == e.ttype && C > 0))
              return [null, t];
            switch (
              (e.ttype == E && (e = O((t = e.output + R(t, e.input.length)))),
              e.ttype)
            ) {
              case 7:
              case 0:
              ...
              case 15:
              case 1:
                if (null == (a = M((t = R(t, e.input.length))))[0])
                ...
                return (
                  (i = d(e.tag, a[0])).setAttribute(e.atname, e.atval),
                  [i, a[1]]
                );
              case 2:
                if (null == (a = M((t = R(t, e.input.length))))[0])
          ...
          function k(t) {
            ...
            if (
              ...
              if (
                (null == (r = M((t = R(t, e.input.length))))[0]
            ...
            do {
              ((a = (s = k((t = R(t, 0))))[0]),
                3 == (i = O((t = s[1]))).ttype && "/" == i.input
                  ? (null == (s = k((t = R(t, i.input.length))))[0]
            ...
            if (5 == i.ttype || 9 == i.ttype) {
                      ...
                      for (r = 0; r < m; r += 2) {
                        for (
                          E = n.createDocumentFragment(),
                            ...
                            T = (a = o.firstChild).childNodes.length,
                            x = 0,
                          ...
                          void 0 !== p[r][x] && f == p[r][x]
                            ? (a.removeChild(a.firstChild),
                              ...
                              "\u2223" ==
                                a.firstChild.firstChild.firstChild.nodeValue
                                ? (0 == r && g.push("solid"),
                                  a.removeChild(a.firstChild),
                                  a.removeChild(a.firstChild),
                                  (f += 2),
                        ...
                        (E.appendChild(d("mtd", y)),
                          ...
                          o.childNodes.length > 2 &&
                            ...
                            o.removeChild(o.firstChild)),
                          S.appendChild(d("mtr", E)));
                      }
                      ((a = d("mtable", S)).setAttribute(
                        "columnlines",
                        g.join(" "),
                      ),
              ...
              ((t = R(t, i.input.length)),
                ("boolean" == typeof i.invisible && i.invisible) ||
                  ((a = d("mo", n.createTextNode(i.output))),
                  o.appendChild(a)));
            }
            return [o, t];
          }
      ...
      885(t, e, i) {
        ((MathJax = Object.assign(i.g.MathJax || {}, i(123).E)),
          MathJax.config &&
          ...
          i(124),
          i(287),
          (t.exports.m = MathJax.InputJax.AsciiMath));
      },
    },
    e = {};
  function i(n) {
  ...
  ((i.d = (t, e) => {
    ...
    (() => {
      "use strict";
      var t = {};
      (i.r(t), i.d(t, { LegacyAsciiMath: () => u }));
      var e = {};
      (i.r(e), i.d(e, { FindAsciiMath: () => E }));
      var n = {};
      (i.r(n), i.d(n, { AsciiMath: () => y }));
      const a = ("undefined" != typeof window ? window : i.g).MathJax._
          .components.global,
        s =
          (a.GLOBAL,
          a.isObject,
          a.combineConfig,
          a.combineDefaults,
          a.combineWithMathJax),
        r = (a.MathJax, MathJax._.core.InputJax.AbstractInputJax);
      var o = i(885);
      const l = new (0, MathJax._.core.MmlTree.MmlFactory.MmlFactory)(),
        u = {
          Compile: function (t, e) {
            const i = { type: "math/asciimath", innerText: t, MathJax: {} },
              n = o.m.Translate(i).root.toMmlNode(l);
            return (n.setInheritedAttributes({}, e, 0, !1), n);
          },
          Translate: function (t, e) {
            return this.Compile(t, e);
          },
        },
        h = MathJax._.util.Options,
        p =
          (h.isObject,
          h.APPEND,
          h.REMOVE,
          ...
          h.userOptions,
          h.selectOptions,
          h.selectOptionsFromKeys,
          h.separateOptions),
        c = (h.lookup, MathJax._.core.FindMath.AbstractFindMath),
        d = MathJax._.util.string,
        m = (d.sortLength, d.quotePattern),
        f =
          (d.unicodeChars,
          d.unicodeString,
          d.isPercent,
        ...
        g = f.protoItem;
      (f.AbstractMathItem, f.STATE, f.newState);
      class E extends c {
        constructor(t) {
        ...
        getPatterns() {
          const t = this.options,
            e = [];
          ((this.end = {}),
            t.delimiters.forEach((t) => this.addPattern(e, t, !1)),
            (this.start = new RegExp(e.join("|"), "g")),
            (this.hasPatterns = e.length > 0));
        }
        addPattern(t, e, i) {
          const [n, a] = e;
          (t.push(m(n)), (this.end[n] = [a, i, new RegExp(m(a), "g")]));
        }
        findEnd(t, e, i, n) {
          const [, a, s] = n,
            r = (s.lastIndex = i.index + i[0].length),
            o = s.exec(t);
          return o
            ? g(
                i[0],
                o.index < r ? "" : t.substring(r, o.index),
                o[0],
                e,
                i.index,
                o.index + o[0].length,
      ...
      class y extends r {
        constructor(t) {
          const [, e, i] = p(t, E.OPTIONS, y.OPTIONS);
          (super(i),
            (this.findAsciiMath = this.options.FindAsciiMath || new E(e)));
        }
        compile(t, e) {
          return u.Compile(t.math, t.display);
        }
        findMath(t) {
      ...
      ((y.NAME = "AsciiMath"),
        (y.OPTIONS = Object.assign(Object.assign({}, r.OPTIONS), {
          FindAsciiMath: null,
        })),
        MathJax.loader &&
          MathJax.loader.checkVersion("input/asciimath", "4.1.2", "input"),
        s({
          _: {
            input: {
              asciimath_ts: n,
              asciimath: { FindAsciiMath: e, legacy_ts: t },
            },
          },
        }),
        MathJax.startup &&
          (MathJax.startup.registerConstructor("asciimath", y),
