(() => {
  ...
  var __webpack_modules__ = {
      50(e, t, l) {
        l.d(t, { Eg: () => m, bK: () => n });
        const s = ("undefined" != typeof window ? window : l.g).MathJax._
            .components.global,
          n =
            (s.GLOBAL,
            s.isObject,
      ...
      615(e, t, l) {
        l.d(t, { Q: () => n });
        const s = l(50).Eg.config || {},
          n = () => s?.loader?.paths?.mathjax || s?.__dirname || "/";
      },
      2(
        ...
        var _root_root_js__WEBPACK_IMPORTED_MODULE_0__ =
        ...
        function createTransform() {
          ...
          const Saxon = nodeRequire("saxon-js"),
            ...
            xslt = nodeRequire(
              path.resolve(
                (0, _root_root_js__WEBPACK_IMPORTED_MODULE_0__.Q)(),
                "input",
                "mml",
                "extensions",
                "mml3.sef.json",
  ...
  function __webpack_require__(e) {
    ...
    return (
      __webpack_modules__[e](l, l.exports, __webpack_require__),
      l.exports
    );
  }
  ((__webpack_require__.d = (e, t) => {
    for (var l in t)
      __webpack_require__.o(t, l) &&
        !__webpack_require__.o(e, l) &&
  ...
  var __webpack_exports__ = {},
    mml3_namespaceObject = {};
  (__webpack_require__.r(mml3_namespaceObject),
    __webpack_require__.d(mml3_namespaceObject, {
      Mml3: () => Mml3,
      Mml3Handler: () => Mml3Handler,
    }));
  var global = __webpack_require__(50);
  const VERSION = "4.1.2";
  var mml3_node = __webpack_require__(2);
  class Mml3 {
    constructor(e) {
      if ("undefined" == typeof XSLTProcessor)
        this.transform = (0, mml3_node.createTransform)();
      else {
        const t = new XSLTProcessor(),
          l = e.adaptor.parse(Mml3.XSLT, "text/xml");
        (t.importStylesheet(l),
          (this.transform = (l) => {
            const s = e.adaptor,
              n = s.node("div", {}, [s.clone(l)]),
              m = s.parse(s.serializeXML(n), "text/xml"),
              o = t.transformToDocument(m);
            return o ? s.tags(o, "math")[0] : l;
          }));
      }
    }
    mmlFilter(e) {
  ...
  function Mml3Handler(e) {
    var t;
    return (
      (e.documentClass =
        (((t = class extends e.documentClass {
          constructor(...e) {
            super(...e);
            for (const e of this.inputJax || [])
              if ("MathML" === e.name) {
                if (!e.options._mml3) {
                  const t = new Mml3(this);
                  (e.mmlFilters.add(t.mmlFilter.bind(t)),
                    (e.options._mml3 = !0));
                }
                break;
              }
          }
        }).OPTIONS = Object.assign(Object.assign({}, e.documentClass.OPTIONS), {
          enableMml3: !0,
        })),
        t)),
      e
  ...
  ((Mml3.XSLT =
    ...
    (0, global.bK)({
      _: {
        input: {
          mathml: {
            mml3: { "mml3-node": mml3_node, mml3: mml3_namespaceObject },
          },
        },
      },
    }),
    MathJax.startup && MathJax.startup.extendHandler((e) => Mml3Handler(e)));
})();
