(() => {
  ...
  (t.r(e),
    t.d(e, {
      MhchemConfiguration: () => M,
      MhchemMethods: () => w,
      MhchemReplacements: () => v,
      MhchemUtils: () => q,
    }));
  const o = ("undefined" != typeof window ? window : t.g).MathJax._.components
      .global,
    n = (o.GLOBAL, o.isObject, o.combineConfig, o.combineDefaults),
    a = o.combineWithMathJax,
    r = (o.MathJax, MathJax._.input.tex.HandlerTypes),
    i = r.ConfigurationType,
    c = r.HandlerType,
    p = MathJax._.input.tex.Configuration,
    s = p.Configuration,
    u =
      (p.ConfigurationHandler,
      p.ParserConfiguration,
    ...
    _ =
      ...
      u.AbstractParseMap,
      u.CharacterMap),
    h = (u.DelimiterMap, u.MacroMap, u.CommandMap),
    m = (u.EnvironmentMap, MathJax._.input.tex.TexError.default),
    l = MathJax._.input.tex.base.BaseMethods,
    d = (l.splitAlignArray, l.default),
    f = MathJax._.input.tex.ams.AmsMethods.AmsMethods;
  /*!
   *************************************************************************
   *
   *  mhchemParser.ts
  ...
  function g(t) {
    ...
    for (e in t)
      for (o in t[e]) {
        let a = o.split("|");
        t[e][o].stateArray = a;
        for (let t = 0; t < a.length; t++) n[a[t]] = [];
      }
    for (e in t)
      for (o in t[e]) {
        let a = t[e][o].stateArray || [];
        for (let r = 0; r < a.length; r++) {
          const i = t[e][o];
          i.action_ = [].concat(i.action_);
          for (let t = 0; t < i.action_.length; t++)
            "string" == typeof i.action_[t] &&
              (i.action_[t] = { type_: i.action_[t] });
          const c = e.split("|");
          for (let t = 0; t < c.length; t++)
            if ("*" === a[r]) {
              let e;
              for (e in n) n[e].push({ pattern: c[t], task: i });
            } else n[a[r]].push({ pattern: c[t], task: i });
        }
      }
    return n;
  }
  const b = {
      go: function (t, e) {
        ...
        for (;;) {
          o !== t ? ((r = 10), (o = t)) : r--;
          let c = b.stateMachines[e],
            p = c.transitions[n] || c.transitions["*"];
          t: for (let e = 0; e < p.length; e++) {
            let o = b.patterns.match_(p[e].pattern, t);
            if (o) {
              const r = p[e].task;
              for (let t = 0; t < r.action_.length; t++) {
                let e;
                if (c.actions[r.action_[t].type_])
                  e = c.actions[r.action_[t].type_](
                    a,
                    o.match_,
                    r.action_[t].option,
                  );
                else {
                  if (!b.actions[r.action_[t].type_])
                    throw [
                      "MhchemBugA",
              ...
              if (((n = r.nextState || n), !(t.length > 0))) return i;
              if ((r.revisit || (t = o.remainder), !r.toContinue)) break t;
            }
          }
      ...
      concatArray: function (t, e) {
        if (e)
          if (Array.isArray(e)) for (let o = 0; o < e.length; o++) t.push(e[o]);
          else t.push(e);
      },
      patterns: {
        patterns: {
          ...
          "state of aggregation $": function (t) {
            const e = b.patterns.findObserveGroups(
              t,
              "",
              /^\([a-z]{1,3}(?=[\),])/,
              ")",
          ...
          "...": /^\.\.\.(?=$|[^.])/,
          "^{(...)}": function (t) {
            return b.patterns.findObserveGroups(t, "^{", "", "", "}");
          },
          "^($...$)": function (t) {
            return b.patterns.findObserveGroups(t, "^", "$", "$", "");
          },
          "^a": /^\^([0-9]+|[^\\_])/,
          "^\\x{}{}": function (t) {
            return b.patterns.findObserveGroups(
              t,
              "^",
              /^\\[a-zA-Z]+\{/,
              "}",
          ...
          "'": /^'/,
          "_{(...)}": function (t) {
            return b.patterns.findObserveGroups(t, "_{", "", "", "}");
          },
          "_($...$)": function (t) {
            return b.patterns.findObserveGroups(t, "_", "$", "$", "");
          },
          ...
          "${(...)}$__$(...)$": function (t) {
            return (
              b.patterns.findObserveGroups(t, "${", "", "", "}$") ||
              b.patterns.findObserveGroups(t, "$", "", "", "$")
            );
          },
          "=<>": /^[=<>]/,
          ...
          arrowUpDown: /^(?:v|\(v\)|\^|\(\^\))(?=$|[\s,;\)\]\}])/,
          "\\bond{(...)}": function (t) {
            return b.patterns.findObserveGroups(t, "\\bond{", "", "", "}");
          },
          "->": /^(?:<->|<-->|->|<-|<=>>|<<=>|<=>|[\u2192\u27F6\u21CC])/,
          CMT: /^[CMT](?=\[)/,
          "[(...)]": function (t) {
          ...
          "\\color{(...)}": function (t) {
            return b.patterns.findObserveGroups(t, "\\color{", "", "", "}");
          },
          "\\color{(...)}{(...)}": function (t) {
            return (
              b.patterns.findObserveGroups(
                t,
                "\\color{",
                "",
                "",
          ...
          "\\ce{(...)}": function (t) {
            return b.patterns.findObserveGroups(t, "\\ce{", "", "", "}");
          },
          "\\pu{(...)}": function (t) {
            return b.patterns.findObserveGroups(t, "\\pu{", "", "", "}");
          },
          ...
          amount: function (t) {
            ...
            const o = b.patterns.findObserveGroups(t, "", "$", "$", "");
            return o &&
              ((e = o.match_.match(
        ...
        findObserveGroups: function (t, e, o, n, a, r, i, c, p, s) {
          ...
          if (((t = t.substr(_.length)), (_ = u(t, o)), null === _))
            return null;
          const h = (function (t, e, o) {
            let n = 0;
            for (; e < t.length;) {
              let a = t.charAt(e);
              const r = u(t.substr(e), o);
              if (null !== r && 0 === n)
          ...
          const m = t.substring(0, n ? h.endMatchEnd : h.endMatchBegin);
          if (r || i) {
            const e = this.findObserveGroups(
              t.substr(h.endMatchEnd),
              r,
              i,
              c,
              p,
            ...
            const o = [m, e.match_];
            return { match_: s ? o.join("") : o, remainder: e.remainder };
          }
          return { match_: m, remainder: t.substr(h.endMatchEnd) };
        },
        match_: function (t, e) {
          const o = b.patterns.patterns[t];
          if (void 0 === o)
            throw ["MhchemBugP", "mhchem bug P. Please report. (" + t + ")"];
          if ("function" == typeof o) return b.patterns.patterns[t](e);
          {
            const t = e.match(o);
            return t
              ? t.length > 2
      ...
      actions: {
        ...
        "tex-math": function (t, e) {
          return b.go(e, "tex-math");
        },
        "tex-math tight": function (t, e) {
          return b.go(e, "tex-math tight");
        },
        bond: function (t, e, o) {
      ...
      stateMachines: {
          ...
          actions: {
            "o after d": function (t, e) {
              ...
              if ((t.d || "").match(/^[1-9][0-9]*$/)) {
                ...
                ((t.d = void 0),
                  (o = this.output(t)),
                  o.push({ type_: "tinySkip" }),
                  (t.b = e));
              } else o = this.output(t);
              return (b.actions["o="](t, e), o);
            },
            "d= kv": function (t, e) {
              ((t.d = e), (t.dType = "kv"));
            },
            "charge or bond": function (t, e) {
              if (t.beginsWithBond) {
                let o = [];
                return (
                  b.concatArray(o, this.output(t)),
                  b.concatArray(o, b.actions.bond(t, e, "-")),
                  o
                );
              }
              t.d = e;
            ...
            "- after o/d": function (t, e, o) {
              let n = b.patterns.match_("orbital", t.o || "");
              const a = b.patterns.match_(
                  "one lowercase greek letter $",
                  t.o || "",
                ),
                r = b.patterns.match_(
              ...
              return (
                c
                  ? (b.concatArray(p, this.output(t)),
                    p.push({ type_: "hyphen" }))
                  : ((n = b.patterns.match_("digits", t.d || "")),
                    o && n && "" === n.remainder
                      ? (b.concatArray(p, b.actions["d="](t, e)),
                        b.concatArray(p, this.output(t)))
                      : (b.concatArray(p, this.output(t)),
                        b.concatArray(p, b.actions.bond(t, e, "-")))),
                p
              );
            },
            "a to o": function (t) {
            ...
            "state of aggregation": function (t, e) {
              return { type_: "state of aggregation", p1: b.go(e, "o") };
            },
            comma: function (t, e) {
              const o = e.replace(/\s*$/, "");
                  ...
                  (t.a || t.b || t.p || t.o || t.q || t.d || o) &&
                    ...
                    t.o || t.q || t.d || t.b || t.p || 2 === o
                      ? t.o || t.q || t.d || (!t.b && !t.p)
                        ? t.o &&
                          "kv" === t.dType &&
                          b.patterns.match_("d-oxidation$", t.d || "")
                          ? (t.dType = "oxidation")
                          : t.o &&
                            "kv" === t.dType &&
                            !t.q &&
            ...
            "oxidation-output": function (t, e) {
              let o = ["{"];
              return (b.concatArray(o, b.go(e, "oxidation")), o.push("}"), o);
            },
            ...
            "color-output": function (t, e) {
              return { type_: "color", color1: e[0], color2: b.go(e[1], "ce") };
            },
            "r=": function (t, e) {
              t.r = e;
            },
        ...
        pq: {
          ...
          actions: {
            ...
            "color-output": function (t, e) {
              return { type_: "color", color1: e[0], color2: b.go(e[1], "pq") };
            },
          },
        },
        bd: {
          ...
          actions: {
            "color-output": function (t, e) {
              return { type_: "color", color1: e[0], color2: b.go(e[1], "bd") };
            },
          },
        },
        oxidation: {
          ...
          actions: {
            "roman-numeral": function (t) {
              return { type_: "roman numeral", p1: t.o || "" };
            },
          },
        },
        "tex-math": {
        ...
        pu: {
          ...
          actions: {
            enumber: function (t, e) {
              ...
              return (
                "+-" === e[0] || "+/-" === e[0]
                  ...
                  : e[0] && o.push(e[0]),
                e[1] &&
                  (b.concatArray(o, b.go(e[1], "pu-9,9")),
                  e[2] &&
                    (e[2].match(/[,.]/)
                      ? b.concatArray(o, b.go(e[2], "pu-9,9"))
                      : o.push(e[2])),
                  (e[3] || e[4]) &&
                    ("e" === e[3] || "*" === e[4]
                      ? o.push({ type_: "cdot" })
            ...
            output: function (t) {
              let e;
              const o = b.patterns.match_("{(...)}", t.d || "");
              o && "" === o.remainder && (t.d = o.match_);
              const n = b.patterns.match_("{(...)}", t.q || "");
              if (
                ...
                const o = { d: b.go(t.d, "pu"), q: b.go(t.q, "pu") };
                "//" === t.o
        ...
        "pu-2": {
          ...
          actions: {
            ...
            output: function (t) {
              let e = [];
              if (t.rm) {
                const o = b.patterns.match_("{(...)}", t.rm || "");
                e =
                  o && "" === o.remainder
                    ? b.go(o.match_, "pu")
                    : { type_: "rm", p1: t.rm };
          ...
          actions: {
            ...
            "output-0": function (t) {
              ...
              if (((t.text_ = t.text_ || ""), t.text_.length > 4)) {
                let o = t.text_.length % 3;
                0 === o && (o = 3);
                for (let o = t.text_.length - 3; o > 0; o -= 3)
                  (e.push(t.text_.substr(o, 3)),
    ...
    y = {
      go: function (t, e) {
        ...
        for (let e = 0; e < t.length; e++) {
          ...
          "string" == typeof a
            ? (o += a)
            : ((o += y._go2(a)), "1st-level escape" === a.type_ && (n = !0));
        }
        return (e && !n && o && (o = "{" + o + "}"), o);
      },
      _goInner: function (t) {
      ...
      _go2: function (t) {
        ...
        switch (t.type_) {
          case "chemfive":
            ...
            (o.a &&
              ...
              (o.b || o.p) &&
                ...
                (e += "{\\vphantom{A}}"),
                (e +=
                  "^{\\smash[t]{\\vphantom{2}}\\llap{" + (o.b || "") + "}}"),
                (e +=
                  "_{\\vphantom{2}\\llap{\\smash[t]{" + (o.p || "") + "}}}")),
              o.o &&
                (o.o.match(/^[+\-]/) && (o.o = "{" + o.o + "}"), (e += o.o)),
              "kv" === t.dType
                ? ((o.d || o.q) && (e += "{\\vphantom{A}}"),
                  o.d && (e += "^{" + o.d + "}"),
                  o.q && (e += "_{\\smash[t]{" + o.q + "}}"))
                : "oxidation" === t.dType
                  ? (o.d && ((e += "{\\vphantom{A}}"), (e += "^{" + o.d + "}")),
                    o.q &&
                      ((e += "{\\vphantom{A}}"),
                      (e += "_{\\smash[t]{" + o.q + "}}")))
                  : (o.q &&
          ...
          case "state of aggregation":
            e = "\\mskip2mu " + y._goInner(t.p1);
            break;
          case "state of aggregation subscript":
            e = "\\mskip1mu " + y._goInner(t.p1);
            break;
          case "bond":
            if (((e = y._getBond(t.kind_)), !e))
              throw [
                "MhchemErrorBond",
          ...
          case "pu-frac":
            const a =
              "\\frac{" + y._goInner(t.p1) + "}{" + y._goInner(t.p2) + "}";
            e =
              "\\mathchoice{\\textstyle" +
              a +
              "}{" +
          ...
          case "1st-level escape":
            ...
            break;
          case "frac-ce":
            e = "\\frac{" + y._goInner(t.p1) + "}{" + y._goInner(t.p2) + "}";
            break;
          case "overset":
            e = "\\overset{" + y._goInner(t.p1) + "}{" + y._goInner(t.p2) + "}";
            break;
          case "underset":
            e =
              "\\underset{" + y._goInner(t.p1) + "}{" + y._goInner(t.p2) + "}";
            break;
          case "underbrace":
            e =
              "\\underbrace{" +
            ...
            break;
          case "color":
            e = "{\\color{" + t.color1 + "}{" + y._goInner(t.color2) + "}}";
            break;
          case "color0":
            e = "\\color{" + t.color + "}";
            break;
          case "arrow":
            const r = { rd: y._goInner(t.rd), rq: y._goInner(t.rq) };
            let i = y._getArrow(t.r);
            (r.rd || r.rq
              ? "<=>" === t.r ||
                "<=>>" === t.r ||
                "<<=>" === t.r ||
                "<--\x3e" === t.r
                ? ((i = "\\long" + i),
                  r.rd && (i = "\\overset{" + r.rd + "}{" + i + "}"),
                  r.rq &&
                    (i =
                      "<--\x3e" === t.r
                        ? "\\underset{\\lower2mu{" + r.rq + "}}{" + i + "}"
                        : "\\underset{\\lower6mu{" + r.rq + "}}{" + i + "}"),
                  (i = " {}\\mathrel{" + i + "}{} "))
                : (r.rq && (i += "[{" + r.rq + "}]"),
                  (i += "{" + r.rd + "}"),
                  (i = " {}\\mathrel{\\x" + i + "}{} "))
  ...
  const $ = MathJax._.core.MmlTree.MmlNode,
    S = $.TEXCLASS,
    q =
      ($.TEXCLASSNAMES,
      $.MATHVARIANTS,
      ...
      $.XMLNode,
      {
        relmo(t, e) {
          const o = Object.assign(
              { stretchy: !0, texClass: S.REL, mathvariant: "-mhchem" },
              e.attributes || {},
            ),
            n = t.create("token", "mo", o, e.char);
          t.Push(n);
        },
      }),
    v = new Map([
      ...
      [
        (t, e) => {
          const o = `mhchem${e}`;
          return A.lookup(o) || k.lookup(o) ? `\\${o}` : t;
        },
    ...
    w = {
      Machine(t, e, o) {
        ...
        try {
          a = x.toTex(n, o);
          for (const [t, e] of v.entries()) a = a.replace(e, t);
        } catch (t) {
          throw new m(t[0], t[1]);
        }
        ((t.string = a + t.string.substring(t.i)), (t.i = 0));
      },
      Macro: d.Macro,
      xArrow: f.xArrow,
    },
    k = new h("mhchem", {
      ce: [w.Machine, "ce"],
      pu: [w.Machine, "pu"],
      mhchemxrightarrow: [w.xArrow, 58409, 5, 9],
      mhchemxleftarrow: [w.xArrow, 58408, 9, 5],
      mhchemxleftrightarrow: [w.xArrow, 58410, 9, 9],
      mhchemxleftrightarrows: [w.xArrow, 58411, 9, 9],
      mhchemxrightleftharpoons: [w.xArrow, 58376, 5, 9],
      mhchemxRightleftharpoons: [w.xArrow, 58377, 5, 9],
      mhchemxLeftrightharpoons: [w.xArrow, 58378, 9, 11],
    }),
    A = new _("mhchem-chars", q.relmo, {
      tripledash: ["\ue410", { stretchy: !1 }],
      mhchemBondTD: ["\ue411", { stretchy: !1 }],
      mhchemBondTDD: ["\ue412", { stretchy: !1 }],
      mhchemBondDTD: ["\ue413", { stretchy: !1 }],
      mhchemlongleftarrow: "\ue428",
    ...
    M = s.create("mhchem", {
      [i.HANDLER]: { [c.MACRO]: ["mhchem", "mhchem-chars"] },
    });
  (MathJax.loader &&
    MathJax.loader.checkVersion("[tex]/mhchem", "4.1.2", "tex-extension"),
    a({ _: { input: { tex: { mhchem: { MhchemConfiguration: e } } } } }),
    (function (t, e, o = `[fonts]/${e}`) {
      if (MathJax.loader) {
        const a = e.replace(/-font-extension$/, "-extension"),
          r = MathJax.config?.startup?.output || "chtml";
        (n(MathJax.config.loader, "paths", { [a]: o }),
          MathJax._.output?.[r] ||
            n(MathJax.config.loader, "dependencies", {
              [`[${a}]/${r}`]: [`output/${r}`],
            }),
          MathJax.loader.addPackageData(t, {
            extraLoads: [`[${a}]/${r}`],
            rendererExtensions: [a],
          }));
      }
    })("[tex]/mhchem", "mathjax-mhchem-font-extension"));
})();
